...
/* package textgame-0.2.0.0 */
#ifndef VERSION_textgame
#define VERSION_textgame "0.2.0.0"
#endif /* VERSION_textgame */
#ifndef MIN_VERSION_textgame
#define MIN_VERSION_textgame(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  2 || \
  (major1) == 0 && (major2) == 2 && (minor) <= 0)
#endif /* MIN_VERSION_textgame */
...
#define CURRENT_COMPONENT_ID "textgame-0.2.0.0-GDCBAuhAglMJ315d3NTeyB-textgame"
